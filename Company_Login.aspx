        ...
        <ContentTemplate>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="company_email" runat="server" class="form-control" placeholder="Enter Company Eamil"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Valid Name" ControlToValidate="company_email" Display="static" Font-Bold="True" ValidationGroup="admin" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
            ...
            <div class="content">
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                    <asp:GridView ID="example1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="company_id" DataSourceID="SqlDataSource1">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions" ItemStyle-Width="200px">
                               ...
                               <asp:ImageButton ID="del" runat="server" CommandName="del" CausesValidation="false" OnClientClick="return message(this);" Text="Delete" CommandArgument='<%# Eval("company_id") %>' Height="35px" Width="35px" ImageUrl="img/bin.png"/>
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="email" runat="server" CommandName="email" CausesValidation="false" OnClientClick="return message(this);" Text="email" CommandArgument='<%# Eval("company_id") %>' Height="35px" Width="35px" ImageUrl="img/email.png"/>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
